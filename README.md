...
honorato is a chat bot built on the [Hubot][hubot] framework. It was initially generated by [generator-hubot][generator-hubot], and configured to be deployed on [Heroku][heroku] to get you up and running as quick as possible.
...
### Running honorato Locally

You can test your hubot by running the following.

You can start honorato locally by running:
...
Then you can interact with honorato by typing `honorato help`.

    honorato> honorato help

    honorato> animate me <query> - The same thing as `image me`, except adds a few
